...
def get_all_neighbourhoods(
    min_properties: int = Query(default=0, description="Filter: minimum number of properties"),
    ...
    valid_sort_fields = [
        "avg_land_value", "total_properties",
        "avg_distance_to_station_km", "avg_yoy_change_pct",
...
@router.get("/{neighbourhood_code}/transit-analysis", response_model=list[TransitProximityDetail])
