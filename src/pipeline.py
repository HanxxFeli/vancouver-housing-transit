...
def run_stage(stage_name: str, stage_func: Callable, skip_on_failure: bool = False) -> bool:
    """"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["ingest", "ingest_properties", "ingest_translink", "transform", "gold"],  # Only allow these values
